import {NAMHAE_BARAE_LIST, NAMHAE_BARAE_SECOND_LIST, NAMHAE_BARAE_THREE_LIST} from "@/data/const/const.js";
...
const BaraeMenu = () => {
    ...
    const {setActiveBaraeArea, activeBaraeArea} = useCreate(useShallow((state)=>({

...
const BaraeFrame = () =>{
    ...
    const {activeMainType, activeBaraeArea} = useKiosk(useShallow((state)=>({
    ...
    useEffect(() => {
        if(activeMainType === MAIN_TYPE.BARAE) {
    ...
    }, [activeMainType, activeBaraeArea]);

    return(
        <ul className="baraegil-wrap">
            <li className={`baraegil__frame baraegil__frame--home ${activeMainType === MAIN_TYPE.BARAE && activeBaraeArea.cd === NAMHAE_AREA.NONE.cd ? 'active' : ''}`}>
                <div className="title">

...
const CctvCreatePlayer = () => {

    const activeModalType = useCreate((state)=> state.activeMenu);
    const activeTourPlace = useCreate((state)=> state.activeTourPlace);
